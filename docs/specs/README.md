...
| ------------------------------------------------------------------ | ------- | ----------------------------------------------------------------------- | ------------------------------------------- |
| [PRD.md](./PRD.md)                                                 | v0.6.0  | What TracingGame does and why; personas, goals, non-goals, KPIs         | (root — none)                               |
| [DEVSPEC.md](./DEVSPEC.md)                                         | v0.8.0  | Architecture, data schema, module behavior, non-functional requirements | PRD v0.6.0                                  |
| [UISPEC.md](./UISPEC.md)                                           | v0.7.0  | Screens, states, visibility rules, Gherkin acceptance criteria          | PRD v0.6.0, DEVSPEC v0.8.0                  |
| [TESTSPEC.md](./TESTSPEC.md)                                       | v0.7.0  | Test inventory proving DEVSPEC/UISPEC requirements                      | PRD v0.6.0, DEVSPEC v0.8.0, UISPEC v0.7.0   |
